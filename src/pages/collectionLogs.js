...
export default function CollectionLogs() {
  ...
  const collectionRef = collection(db,"CollectionLogs");
          ...
          <div className="w-full md:w-12/12 md:mx-2 h-full">
            ...
            <div className="bg-white p-3 shadow-sm rounded-sm h-full">
              <div className="flex items-center space-x-2 font-semibold text-gray-900 leading-8">
                ...
                <span className="tracking-wide">User Logs for Collection Module</span>
              </div>
  ...
  return (
    <tr key={key}>
      ...
      {/* Contact No */}
      <td className="px-5 py-1 border-b border-white-600 bg-white text-sm">{value?.id}</td>
