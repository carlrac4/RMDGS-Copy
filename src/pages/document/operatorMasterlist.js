...
export class OperatorMasterList extends React.Component{
	constructor(props) {
		super(props);
  ...
  render() {
	   //To get
	   const strObjFromStorage = localStorage.getItem('OptMasterList')
					...
					<div class=" top-0 gap-4  flex-col flex border-black">
					   ...
					   <div class="h-full border-black flex align-center justify-center content-center">
						  <div class="flex flex-col gap-2 w-2/3 h-full py-4 px-3 a">
							...
							<div class="p-2 h-12 text-center date border border-red text-base w-full my-2 place-content-center"> <p> Operator's Masterlist</p>
							</div>
                       ...
                       return(
                           ...
                           <tr class="w-full">
                              <td className="w-fit px-3 py-1 border-b border-black-100 bg-white text-sm">
                                 <div className="flex items-center">  <div className="ml-3">
...
export const FunctionalOperatorMasterList = React.forwardRef((props, ref) => {
	// eslint-disable-line max-len
	
	return <OperatorMasterList ref={ref} text={props.text}/>;
  });